        ...
        addSwitchEvent: function( nodeSwitch ) {
            ...
            UTIL.addEvent( nodeSwitch, 'click',
                function( e ) {
                    ...
                    //////////////////////////////////////////////////////////
                    document.getElementById("myImg").src = "./Profiles/P1.png";
                    document.getElementById("myTxt").textContent = "Ramy Emam";
                    if(self.nodeDOM.innerHTML == '<p class="node-num">1</p><a class="collapse-switch"></a>')
                    {
                        document.getElementById("myImg").src = "./Profiles/P1.png";
                        document.getElementById("myTxt").textContent = "Washington Mccormick";;
                    }
                    else if(self.nodeDOM.innerHTML == '<p class="node-num">2</p><a class="collapse-switch"></a>')
                    {
                        document.getElementById("myImg").src = "./Profiles/P2.png";
                        document.getElementById("myTxt").textContent = "Joyce Gregory";;
                    }
                    else if(self.nodeDOM.innerHTML == '<p class="node-num">3</p><a class="collapse-switch"></a>')
                    {
                        document.getElementById("myImg").src = "./Profiles/P3.png";
                        document.getElementById("myTxt").textContent = "Denise Beard";;
                    }
                    else if(self.nodeDOM.innerHTML == '<p class="node-num">4</p><a class="collapse-switch"></a>')
                    {
                        document.getElementById("myImg").src = "./Profiles/P4.png";
                        document.getElementById("myTxt").textContent = "Karen Osborne";;
                    }
                    else if(self.nodeDOM.innerHTML == '<p class="node-num">5</p><a class="collapse-switch"></a>')
                    {
                        document.getElementById("myImg").src = "./Profiles/P5.png";
                        document.getElementById("myTxt").textContent = "Margie Travis";;
                    }
                    else if(self.nodeDOM.innerHTML == '<p class="node-num">6</p><a class="collapse-switch"></a>')
                    {
                        document.getElementById("myImg").src = "./Profiles/P6.png";
                        document.getElementById("myTxt").textContent = "Kara Guy";;
                    }
                    else if(self.nodeDOM.innerHTML == '<p class="node-num">7</p><a class="collapse-switch"></a>')
                    {
                        document.getElementById("myImg").src = "./Profiles/P7.png";
                        document.getElementById("myTxt").textContent = "Robyn Phillips";;
                    }
                    else if(self.nodeDOM.innerHTML == '<p class="node-num">8</p><a class="collapse-switch"></a>')
                    {
                        document.getElementById("myImg").src = "./Profiles/P8.png";
                        document.getElementById("myTxt").textContent = "Corina Romero";;
                    }
                    else if(self.nodeDOM.innerHTML == '<p class="node-num">9</p><a class="collapse-switch"></a>')
                    {
                        document.getElementById("myImg").src = "./Profiles/P9.png";
                        document.getElementById("myTxt").textContent = "Joyce Gregory";;
                    }
                    else if(self.nodeDOM.innerHTML == '<p class="node-num">10</p><a class="collapse-switch"></a>')
                    {
                        document.getElementById("myImg").src = "./Profiles/P10.png";
                        document.getElementById("myTxt").textContent = "Jodie Gould";;
                    }
                    else if(self.nodeDOM.innerHTML == '<p class="node-num">11</p><a class="collapse-switch"></a>')
                    {
                        document.getElementById("myImg").src = "./Profiles/P11.png";
                        document.getElementById("myTxt").textContent = "Parker Harper";;
                    }
                    else if(self.nodeDOM.innerHTML == '<p class="node-num">12</p><a class="collapse-switch"></a>')
                    {
                        document.getElementById("myImg").src = "./Profiles/P12.png";
                        document.getElementById("myTxt").textContent = "Maxine Pope";;
                    }
                    else if(self.nodeDOM.innerHTML == '<p class="node-num">13</p><a class="collapse-switch"></a>')
                    {
                        document.getElementById("myImg").src = "./Profiles/P13.png";
                        document.getElementById("myTxt").textContent = "Debbie Haley";;
                    }
                    else if(self.nodeDOM.innerHTML == '<p class="node-num">14</p><a class="collapse-switch"></a>')
                    {
                        document.getElementById("myImg").src = "./Profiles/P14.png";
                        document.getElementById("myTxt").textContent = "Delaney Dennis";;
                    }
                    else if(self.nodeDOM.innerHTML == '<p class="node-num">15</p><a class="collapse-switch"></a>')
                    {
                        document.getElementById("myImg").src = "./Profiles/P15.png";
                        document.getElementById("myTxt").textContent = "Rivers Sampson";;
                    }
